...
<body>
	...
	<div id="container" role="document">
		...
		<section id="my-story">
			...
			<div id="agnes_high_school">
				<div id="agnes_high_school-inner">
					
	                <div id="agnes_high_school-h6">
	                	<div id="high_line1-1"><h6>IIZUKA</h6></div>
	                	<div id="high_line1-2"><h6>in</h6></div>
	                	<div id="high_line2"><h6>HIGH SCHOOL</h6></div>
	                </div>
	                <div id="agnes_high_school-sub">
			...
			<div id="ryerson">
				<div id="ryerson-inner">
					<div id="ryerson-h6">
						<div id="ryerson-first"><h6>Iizuka</h6></div>
						<div id="ryerson-second"><h6>in</h6></div>
			...
			<div id="agnes_workforce">
				<div id="agnes_workforce-inner">
					<div id="agnes_workforce-h6">
						<div id="agnes_workforce-first"><h6>IIZUKA</h6></div>
						<div id="agnes_workforce-second"><h6>in the</h6></div>
						<div id="agnes_workforce-third"><h6>WORKFORCE</h6></div>
	                </div>
	                ...
	                <div id="ppc">
	                	...
	                	<p>For a duration of 5 months Agnes worked for the Toronto based label “Paper People Clothing”. For her first internship she assisted the designer, Jennifer Fukushima, with the rebranding of “Paper People Clothing” to “Jennifer Fukushima”. During her work with the label, Agnes learned more about the operation of a small label. She gained skills in quality checking, and organization. She also gained knowledge on woven textiles and the operations of a small business.</p>
                	</div>

	                <div id="agnes_workforce-img"></div>
				</div>
			</div>
